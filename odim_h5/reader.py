...
class ODIMReader(object):
    ...
    def root_source_str(self) -> str:
        """Get the root what.source attribute as a string. Example: WMO:06477,RAD:BX41,PLC:Wideumont,NOD:bewid,CTY:605,CMT:VolumeScanZ"""
        return self._extract_root_attribute_str("what", "source")

    @property
    def root_source(self) -> Dict[str, str]:
        """Get the root what.source attribute as a dict. Example: {'WMO':'06477', 'NOD':'bewid', 'RAD':'BX41', 'PLC':'Wideumont'}"""
